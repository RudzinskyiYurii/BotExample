...
public class CoreLogic {
	...
	static class MessageHandle implements HttpHandler {
		...
		MessageHandle(CredentialProvider credentialProvider) {
			...
			this.messageHandlerProxy = new MessageHandlerProxy(credentialProvider);
...
//			invoke core team handler
			messageHandlerProxy.handle(httpExchange);
